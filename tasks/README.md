...
| T15 | The first minute and the handbook: MCP / API / Integrations door, first-access presentation, Skills console, docs/guide in en/pt/es (spec v0.49 → J.5.1/J.5.11/J.5.12 + F.52–F.53) | in-progress (2026-08-13: spec + Studio + handbook shipped; user's real-browser pass and commit remain) |
