...
| T18 | Extensions: third-party modules, installed by the operator (spec v0.80 Part L) | in-progress (2026-09-08: spec + engine runtime + `vine ext` + Station governance + all ten seams + Studio console + 100 tests green; remaining: gpg measurement, curated index, extending.md, browser pass, first real extension) |
