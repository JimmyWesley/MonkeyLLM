...
- The spec is the truth (`docs/monkeyllm-spec-v0.11.md`): contract changes
...
| T04 | Phase 2: Living Bank (Gardener, Ranger, dataset writes) | in-progress (tend v0.7; dataset birth v0.8; Gardener core v0.9; Ranger v0.10; curation measured 100%; tiered storage v0.11 complete incl. fetchers/prefetch/snapshots — DOCX converter, edge proposals, convergence curve remain) |
