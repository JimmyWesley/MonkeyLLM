...
- The spec is the truth (`docs/monkeyllm-spec-v0.9.md`): contract changes
...
| T04 | Phase 2: Living Bank (Gardener, Ranger, dataset writes) | in-progress (tend v0.7; dataset birth v0.8; Gardener deterministic core v0.9 — LLM curation + DOCX converter + Ranger remain) |
