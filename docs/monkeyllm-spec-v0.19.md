# MonkeyLLM — Technical Specification v0.19 (Phase 0/1/2 + host layer)
...
1. **grant** — create or replace their access on one forest
2. **revoke access** — remove their access to one forest
