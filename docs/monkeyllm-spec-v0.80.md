# MonkeyLLM Technical Specification v0.80 (Phase 0/1/2 + host layer)
...
1. **Conformance kit** — the manifest against the schema, `station_compat`
   against the host, declared handlers importable, a document round-trip
   against the fixture forest, and L.10's configurability rule. This is a
