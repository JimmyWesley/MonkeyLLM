        ...
        <header className="sticky top-0 z-30 flex items-center gap-2 border-b
          ...
          <button className="flex min-w-0 flex-1 items-center gap-2.5 text-left"
            ...
            <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg
                             bg-accent text-accent-fg"><Forest size={17} /></span>
    ...
    <div className="border-b border-line p-2.5" ref={box}>
      ...
      {!collapsed && (
        <div className="mb-2 flex items-center gap-2 px-1.5 pt-1">
          <span className="grid h-6 w-6 shrink-0 place-items-center rounded-md bg-accent
                           text-accent-fg"><Forest size={15} /></span>
      ...
      <div className="relative">
        {collapsed ? (
          <button className="mx-auto grid h-9 w-9 place-items-center rounded-lg bg-accent
                             text-accent-fg transition hover:bg-accent-hover"
